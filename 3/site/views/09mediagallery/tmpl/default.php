   ...
   <table width="100%" align="<?php echo $this->table ?>"><tr><td>
	<div id="flashcontent"> 
		...
		<script type="text/javascript"> 
			var so = new SWFObject("<?php echo JURI::root() ?>components/com_oziogallery3/skin/mediagallery/mediaGallery.swf", "gallery", "<?php echo $this->larghezza ?>", "<?php echo $this->altezza ?>", "6", "#333333");
 <?php if  	  ( $this->xml_mode == 0 ) : ?>
			so.addVariable("data_source", "<?php echo JURI::root() ?>components/com_oziogallery3/skin/mediagallery/xml/mediagallery_<?php echo $this->nomexml ?>.ozio") 
<?php else: ?>
