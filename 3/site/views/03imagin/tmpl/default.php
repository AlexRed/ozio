...
<?php endif; ?>
   <table align="<?php echo $this->table ?>"><tr><td>
	...
	<script src="<?php echo JURI::root() ?>components/com_oziogallery3/imagin/scripts_ralcr/js/flash_resize.js"></script>
	<script src="<?php echo JURI::root() ?>components/com_oziogallery3/imagin/scripts_ralcr/js/swfmacmousewheel2.js"></script>
	<script src="<?php echo JURI::root() ?>components/com_oziogallery3/imagin/scripts_ralcr/js/swfaddress.js"></script>
	<script src="<?php echo JURI::root() ?>components/com_oziogallery3/imagin/scripts_ralcr/js/swfaddress-optimizer.js?flash=9"></script>
	
	<script language="JavaScript">
		var imagin_scripts_path = "components/com_oziogallery3/imagin/scripts_ralcr/"; // a path relative to the html which embeds the swf
		...
		swfobject.embedSWF ("<?php echo JURI::root() ?>components/com_oziogallery3/imagin/imagin.swf?"+Math.random()*1, imagin_instance, imagin_swf_width, imagin_swf_height, "9",
