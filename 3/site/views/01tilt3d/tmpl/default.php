	...
	<div id="ozioflashcontent" class="oziofloat">
			<a href="http://www.macromedia.com/go/getflashplayer">Get the Flash Player</a> to see this rotator.
				...
				<script type="text/javascript">
					var fo = new SWFObject("<?php echo JURI::root() ?>components/com_oziogallery3/skin/tiltviewer/TiltViewer.swf","viewer","<?php echo $this->larghezza ?>","<?php echo $this->altezza ?>", "9.0.28", "#<?php echo $this->bkgndoutercolor ?>");
...
<?php if  	  ( $this->xml_mode == 0 ) : ?>
					fo.addVariable("xmlURL","<?php echo JURI::root() ?>components/com_oziogallery3/skin/tiltviewer/xml/tiltviewer_<?php echo $this->nomexml ?>.ozio"); 
<?php else: ?>
