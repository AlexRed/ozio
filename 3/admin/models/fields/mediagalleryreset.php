...
class JFormFieldMediagalleryreset extends JFormField
{
	public $type = 'Mediagalleryreset';
	
	protected function getInput()
	{
		JHTML::_('behavior.modal', 'a.modal');
		$link = 'index.php?option=com_oziogallery3&amp;task=resetmediagallery&amp;tmpl=component';
