...
<script type="text/javascript">
		...
		var so = new SWFObject("<?php echo JURI::root().'components/com_oziogallery2/skin/accordion/preview.swf';?>?"+Math.random()*1, "sotester", stageW, stageH, "9", "<?php echo $this->loadercolor;?>");
