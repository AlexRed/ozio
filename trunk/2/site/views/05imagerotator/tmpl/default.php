	...
	<div id="oziocontainer" class="oziofloat">
			<a href="http://www.macromedia.com/go/getflashplayer">Get the Flash Player</a> to see this rotator.
				...
				<script type="text/javascript">
					var s1 = new SWFObject("<?php echo JURI::root() ?>components/com_oziogallery2/skin/imagerotator/imagerotator.swf?"+Math.random()*1,"rotator","<?php echo $this->larghezza ?>","<?php echo $this->altezza ?>","7");
...
<?php elseif  ( $this->xml_moder == 0 ) : ?>
					s1.addVariable("file","<?php echo JURI::root() ?>components/com_oziogallery2/skin/imagerotator/xml/imagerotator_<?php echo $this->nomexml ?>.ozio?"+Math.random()*1); 
