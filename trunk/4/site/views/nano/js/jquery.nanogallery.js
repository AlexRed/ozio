...
this.thumbImgHeight = 0;           // thumbnail image height
    ...
    NGItems.prototype = {
      ...
      responsiveURL: function () {
    	  ...
    	  if ($gE.vwContent){
      		container_width=$gE.vwContent.width();
    		container_height=$gE.vwContent.height();
    	  }
      ...
      if( ok ) {
		...
		if( kind == 'image' ) {
  		...
  		newItem.infobox.json_details='';
  		  ...
  		  newItem.infobox.link="https://plus.google.com/photos/"+gO.userID+"/albums/"+albumID+"/"+itemID;
        ...
        if( item.contentLength > 0 ) {
          switch( gO.thumbnailLabel.itemsCount) {
            case 'title':
              ...
              sTitle += ' ' + g_i18nTranslations.thumbnailLabelItemsCountPart1 + '<span class="labelNumPhotoTitle"></span>' + item.contentLength;
              break;
            case 'description':
              ...
              sDesc += ' ' + g_i18nTranslations.thumbnailLabelItemsCountPart1 + '<span class="labelNumPhotoTitle"></span>' + item.contentLength;
              break;
            }
          }
...
//          item.thumbImgWidth=instance.images[0].img.naturalWidth;
  ...
  function ThumbnailClick( $e ) {
    ...
    if( jQuery(window).width() < 768 || gO.touchAnimation == false || gI[n].hovered === true ) {
      OpenThumbnail(n);
    }
    else {
  ...
  function OpenInfoBox(){
		var lat=gI[g_viewerCurrentItemIdx].infobox.lat;
		var lng=gI[g_viewerCurrentItemIdx].infobox.lng;
...
/*	  
	  ...
	  infobox.views='-na-';
	  infobox.comments='-na-';
	  infobox.image=gI[g_viewerCurrentItemIdx].thumbsrc;
	  infobox.lat='34.5';
	  infobox.lng='55.6';
	  infobox.link='#';
	  infobox.download='#';
	  gI[g_viewerCurrentItemIdx].infobox=infobox;
	*/  
	  $gE.conInfoBox.find('.pi-album').text(gI[g_viewerCurrentItemIdx].infobox.album);
	  $gE.conInfoBox.find('.pi-photo').text(gI[g_viewerCurrentItemIdx].infobox.photo);
	  
	  $gE.conInfoBox.find('.pi-photo').html(nano_gi_linkify($gE.conInfoBox.find('.pi-photo').html()));
	  
	  $gE.conInfoBox.find('.pi-date').text(gI[g_viewerCurrentItemIdx].infobox.date);
	  $gE.conInfoBox.find('.pi-dimensions').text(gI[g_viewerCurrentItemIdx].infobox.dimensions);
	  $gE.conInfoBox.find('.pi-filename').text(gI[g_viewerCurrentItemIdx].infobox.filename);
	  $gE.conInfoBox.find('.pi-filesize').text(gI[g_viewerCurrentItemIdx].infobox.filesize);
	  $gE.conInfoBox.find('.pi-camera').text(gI[g_viewerCurrentItemIdx].infobox.camera);
	  $gE.conInfoBox.find('.pi-focallength').text(gI[g_viewerCurrentItemIdx].infobox.focallength);
	  $gE.conInfoBox.find('.pi-exposure').text(gI[g_viewerCurrentItemIdx].infobox.exposure);
	  $gE.conInfoBox.find('.pi-fnumber').text(gI[g_viewerCurrentItemIdx].infobox.fnumber);
	  $gE.conInfoBox.find('.pi-iso').text(gI[g_viewerCurrentItemIdx].infobox.iso);
	  $gE.conInfoBox.find('.pi-make').text(gI[g_viewerCurrentItemIdx].infobox.make);
	  $gE.conInfoBox.find('.pi-flash').text(gI[g_viewerCurrentItemIdx].infobox.flash);
	  $gE.conInfoBox.find('.pi-views').text(gI[g_viewerCurrentItemIdx].infobox.views);
	  $gE.conInfoBox.find('.pi-comments').text(gI[g_viewerCurrentItemIdx].infobox.comments);
	  $gE.conInfoBox.find('.pi-image').attr('src',gI[g_viewerCurrentItemIdx].infobox.image);
	  $gE.conInfoBox.find('.pi-link').attr('href',gI[g_viewerCurrentItemIdx].infobox.link);
	  $gE.conInfoBox.find('.pi-download').attr('href',gI[g_viewerCurrentItemIdx].infobox.download);
...
button.mfp-close, button.mfp-arrow -> z-index: 100046;  
				*/
				...
				var json_details_url=gI[g_viewerCurrentItemIdx].infobox.json_details;
				if (json_details_url!=''){
  ...
  function OpenInternalViewer( imageIdx ) {
	...
	var ib='';
    if (gO.kind=='picasa' && gO.showInfoBoxButton){
    	ib='<div class="ngbt infoButton"></div>';
    }
    ...
    $gE.conVwTb=jQuery('<div class="toolbarContainer" style="visibility:hidden;"><div class="toolbar"><div class="visibilityButton hideToolbarButton ngbt"></div><div class="previousButton ngbt"></div><div class="pageCounter"></div><div class="nextButton ngbt"></div><div class="playButton playPauseButton ngbt"></div>'+fs+ib+sInfo+'<div class="closeButton ngbt"></div><div class="label"><div class="title" itemprop="name"></div><div class="description" itemprop="description"></div></div></div>').appendTo($gE.conVw);
...
//    $gE.conVwTb.css({'visibility':'visible'});
    ...
    if( gI[imageIdx].title !== undefined ) {
      ...
      $gE.conVwTb.find('.title').html(nano_gi_linkify(gI[imageIdx].title));
    }
    else {
