...
//          nbCol++;
  ...
  function paginationPreviousPage() {
    ...
    if( !inViewportVert($gE.base, 0) ) {
      jQuery('html, body').animate({scrollTop: $gE.base.offset().top }, 250);
    }
  ...
  function OpenInternalViewer( imageIdx ) {
    ...
    */
	...
	jQuery(".shareButton").hideshare({
          position: (gO.viewerToolbar.position=="top"?'bottom':'top')
      });
	
	$gE.conHideShare=jQuery(".shareButton");
  ...
  function ToolbarAddElt( elt ) {
    ...
    switch( e ) {
      ...
      case 'infoButton':
        ...
        break;
      case 'shareButton':
		r='<div class="ngbt shareButton"></div>';
        break;
...
//    g_containerViewerDisplayed=true;
  ...
  function DisplayInternalViewerToolbar( imageIdx ) {
    ...
    if( gI[imageIdx].title !== undefined && gI[imageIdx].title != '' ) {
	  ...
	  $gE.conHideShare.data('title',gI[imageIdx].title);
	  
	  
    }
    else {
      $gE.conVwTb.find('.title').html('');
	  $gE.conHideShare.data('title','');
    }
    // set description
    if( gI[imageIdx].description !== undefined && gI[imageIdx].description != '' ) {
	  ...
	  $gE.conHideShare.data('description','');
    }
	
	  $gE.conHideShare.data('link',document.URL);
	  $gE.conHideShare.data('media',gI[imageIdx].src);
