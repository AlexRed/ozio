...
<?php endif; ?>
   ...
   <tr>  
		<td align="<?php echo $this->table ?>">
				<div id="<?php echo $this->oziocode;?>oziopictopicasa">Get the flash player here: http://www.adobe.com/flashplayer</div>
...
<?php endif; ?>				
					...
					so.write("<?php echo $this->oziocode;?>oziopictopicasa");	
				</script>		
		</td>
	</tr>
</table>
