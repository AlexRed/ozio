	...
	<div id="oziogallery" class="oziofloat">
			<a href="http://www.macromedia.com/go/getflashplayer">Get the Flash Player</a> to see this rotator.
				...
				<script type="text/javascript">
					var so = new SWFObject("<?php echo JURI::root() ?>components/com_oziogallery3/skin/flashgallery/flashgallery.swf","gallery","<?php echo $this->larghezza ?>","<?php echo $this->altezza ?>", "8");
					so.addParam("quality", "high");
					so.addParam("allowFullScreen", "true");
					so.addParam("wmode", "transparent");
					so.addVariable("color_path","<?php echo JURI::root() ?>components/com_oziogallery3/skin/flashgallery/xml/settings_<?php echo $this->nomexml ?>.ozio");					
<?php if ( $this->flickr == 1 ) : ?>						
					so.addVariable("content_path","http://www.flickr.com/photos/<?php echo $this->user_id ?>");
<?php else: ?>	
					so.addVariable("script_path","<?php echo JURI::root() ?>components/com_oziogallery3/skin/flashgallery/xml/flashgallery_<?php echo $this->nomexml ?>.ozio" );
<?php endif; ?>						
