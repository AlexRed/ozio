	...
	function lightgallery_load_complete(){
			...
			for (var i=0;i<num_slides;i++){
				...
				if (c_slide.kind == 'picasa'){
					...
					<?php
					echo "\n".'var zoom_url='.json_encode(JUri::root(true) . "/media/com_oziogallery4/views/lightgallery/img/zoom.png").';'."\n";
					?>
					...
					<?php
					echo "\n".'var zoom_url='.json_encode(JUri::root(true) . "/media/com_oziogallery4/views/lightgallery/img/play-button.png").';'."\n";
					?>
			...
			?>
				...
				jcontainer.lightGallery({
					...
					data_loading_gif: <?php echo json_encode(JUri::base(true).'/media/com_oziogallery4/views/00fuerte/img/progress.gif'); ?>,
