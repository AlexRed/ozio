		...
		author.pwi(
			{
				...
				//album:'<?php echo ($item->getParams()->get("albumvisibility") == "public") ? $item->getParams()->get("gallery_id", "") : $item->getParams()->get("limitedalbum"); ?>',
				authKey:"<?php echo ''; ?>",
				//StartIndex: 1,
				//MaxResults: 1,
...
//<?php } /*chiusura for*/ ?>
		...
		function addAlbum(album,jquery_ozio_author){
			...
			counter.append('<span class="ozio-indicator ozio-og-camera" ' + 'title="<?php echo JText::_("COM_OZIOGALLERY4_NUMPHOTOS"); ?>">' + album.numphotos + '</span> ');
