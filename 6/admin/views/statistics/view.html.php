...
// 		$this->assignRef('cestinate'			, $cestinate);
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title( JText::_( 'COM_OZIOGALLERY4_OZIO_GALLERY_3' ). ' - ' .JText::_( 'COM_OZIOGALLERY4_STATISTICS' ),'camera' );
		...
		JHtmlSidebar::addEntry( JText::_( 'COM_OZIOGALLERY4_STATISTICS' ), 'index.php?option=com_oziogallery4&view=statistics',true);
