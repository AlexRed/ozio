...
class OzioViewLoader extends JViewLegacy
{
	function display($tpl = null)
	{
		...
		$params = $menu->getParams(intval($application->input->getVar("Itemid", 0, "GET")));
		...
		$loader->IncludePath = JPATH_ADMINISTRATOR . "/components/com_oziogallery4" . $view;
