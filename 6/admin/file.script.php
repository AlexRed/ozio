...
class Com_Oziogallery4InstallerScript
{
	...
	function uninstall($parent)
	{
		...
		echo '<p>The component Ozio Gallery 6 Component for Joomla 4! has been uninstalled successfully.</p>';
	}
	...
	function preflight($type, $parent)
	{
		...
		$this->component_name = $parent->getElement();
	...
	function postflight($type, $parent) {
		...
		$language->load('com_oziogallery4', JPATH_ADMINISTRATOR . '/' . "components" . '/' . "com_oziogallery4", $language_tag, true);
		...
		$html[] ='						<img src="'.JUri::base(true) . "/components/com_oziogallery4/assets/images/buy_now.jpg".'" border="0" alt="Buy now"> ';
		$html[] ='					</a> ';
		$html[] ='				</div> ';
		$html[] ='			<p><strong>'.JText::_("COM_OZIOGALLERY4_PURCHASE").'</strong></p></div> ';
		}
		$html[] ='	</div>';
		$html[] ='	<div class="modal-footer">';
		$html[] ='		<a href="index.php?option=com_oziogallery4&view=setup" class="btn btn-success">'.JText::_("COM_OZIOGALLERY4_SETUP_LINK").'</a>';
	...
	function message()
	{
		echo '<p>Congratulations! Ozio Gallery 6 Component for Joomla 4! has been installed successfully</p>';
		...
		if (!$GLOBALS["oziogallery3"]["registered"])
		{
			...
			<img src="' . JUri::base(true) . '/components/com_oziogallery4/assets/images/buy_now.jpg" border="0" alt="Buy now">
			</a>
			</div>
