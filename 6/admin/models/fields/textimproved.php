...
class JFormFieldTextImproved extends JFormField
{
	...
	public function __construct($form = null)
	{
		...
		{
			JFactory::getDocument()->addStyleSheet(JUri::base(true) . "/components/com_oziogallery4/models/fields/fields.css",array('version' => 'auto'));
			JFactory::getDocument()->addScript(JUri::base(true) . "/components/com_oziogallery4/js/get_id.js",array('version' => 'auto'));
	...
	protected function getInput()
	{
		...
		/*migration_changes
		relace iframe opensourcesolutions with local index.php?option=com_oziogallery4&view=one_tap&tmpl=one_tap
		*/
...
//		$buttons .= '<iframe style="margin:0;padding:0;border:0;width:500px;height:250px;overflow:hidden;" src="index.php?option=com_oziogallery4&view=one_tap&tmpl=one_tap"></iframe>';
		$buttons .= '</div>';
