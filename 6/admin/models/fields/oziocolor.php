...
class JFormFieldOzioColor extends JFormField
{
	...
	protected function getInput()
	{
		...
		if ($resources)
		{
			...
			$document->addScript(JUri::base(true) . "/components/com_oziogallery4/js/jquery.ozio-minicolors.js",array('version' => 'auto'));
			$document->addStyleSheet(JUri::base(true) . "/components/com_oziogallery4/css/jquery.ozio-minicolors.css",array('version' => 'auto'));
