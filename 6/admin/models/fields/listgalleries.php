...
class JFormFieldListGalleries extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($resources)
		{
			...
			//$document->addScript(JUri::base(true) . "/components/com_oziogallery4/js/listgalleries.js",array('version' => 'auto'));
		...
		'<span id="jform_params_' . (string)$this->element["name"] . '_warning" style="display:none;">' . JText::_("COM_OZIOGALLERY4_ERR_INVALID_USER") . '</span>' .
